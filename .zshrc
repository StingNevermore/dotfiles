...
export ZSH=/Users/suncheng/.oh-my-zsh
...
plugins=(git mvn autojump osx brew vi-mode)
...
alias push="git pull --rebase && mvn validate && git push origin head:master"

export LOG_PATH='/Users/suncheng/exec/web'
function web_ecs() {
    ssh web_server@ecs$1
}
function root_js() {
    ssh root@js_stream$1
}

function hls_download() {
     ffmpeg -i "$1" -acodec copy -vcodec copy -absf aac_adtstoasc $2.mkv
}
...
export SDKMAN_DIR="/Users/suncheng/.sdkman"
[[ -s "/Users/suncheng/.sdkman/bin/sdkman-init.sh" ]] && source "/Users/suncheng/.sdkman/bin/sdkman-init.sh"
